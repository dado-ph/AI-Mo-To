...
export function exposeDesktopApi(bridge: ElectronBridge): void {
  ...
  const api: DesktopApi = {
    ...
    listSnapshots: (root) => bridge.ipcRenderer.invoke("snapshots:list", root) as ReturnType<DesktopApi["listSnapshots"]>,
    restoreSnapshot: (root, snapshotId) => bridge.ipcRenderer.invoke("snapshots:restore", root, snapshotId) as ReturnType<DesktopApi["restoreSnapshot"]>,
